...
import { platforma } from "@platforma-open/milaboratories.redefine-clonotypes.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type RedefineClonotypesBlockContract = BlockContract;
export type RedefineClonotypesBlockOutputs  = BlockOutputs;
export type RedefineClonotypesBlockData     = BlockData;
export const RedefineClonotypesBlockPointer = BlockPointer;
